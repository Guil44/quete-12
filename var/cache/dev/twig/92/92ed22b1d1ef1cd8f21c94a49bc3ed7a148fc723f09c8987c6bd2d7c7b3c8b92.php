...
class __TwigTemplate_11deb80d8fd7690e38cfdb37716297af06ab2b4aef72b498f2d085a132ebba46 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["episode"]) {
            ...
            <a href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show_episode", ["id" => twig_get_attribute($this->env, $this->source, $context["episode"], "id", [], "any", false, false, false, 16)]), "html", null, true);
            echo "\">
                <b>
                    ";
            // line 18
...
";
    ...
    {
        return array (  119 => 26,  109 => 22,  100 => 18,  95 => 16,  92 => 15,  88 => 14,  79 => 8,  71 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    {% for episode in episodes %}
        <li>
            <a href=\"{{ path('show_episode', {id: episode.id}) }}\">
                <b>
...
{% endblock %}
", "wild/season.html.twig", "/home/guillaume/Desktop/symfony-quest-11/templates/wild/season.html.twig");
    }
}
